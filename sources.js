window.SOURCES_DATA = {
  ...
  "sources": [
    ...
    },
    {
      ...
      "name": "arxiv — computation / inference offloading",
      "kind": "web-search",
      "category": "academia",
      "topics_hint": [
        "compute-offloading",
      ...
      "notes": "The user named AI/computation offloading as a first-class topic (2026-08-28). Watch for split/collaborative inference, early-exit cascades, and offload policies that are actually evaluated over a real link — those are the ones that connect to the rest of this KB.",
      "technology": "edge-ai"
    },
    {
      "id": "arxiv-federated-edge",
      "name": "arxiv — federated & on-device learning",
      "kind": "web-search",
      "category": "academia",
      "topics_hint": [
        "edge-federated-learning"
      ],
      "notes": "Federated-learning output is enormous and mostly incremental FedAvg variants. Ingest only papers with a real systems or wireless-link contribution, a released artifact, or a deployment — same bar the radio scouts apply to incremental-estimator papers.",
      "technology": "edge-ai"
    },
    {
      "id": "arxiv-edge-model-efficiency",
      "name": "arxiv — quantisation / compression for edge deployment",
      "kind": "web-search",
      "category": "academia",
      "topics_hint": [
        "edge-model-efficiency",
      ...
      "notes": "Bar is high: the quantisation literature is vast. Ingest when the paper reports device-side numbers (latency, memory, energy) rather than accuracy tables alone.",
      "technology": "edge-ai"
    },
    {
